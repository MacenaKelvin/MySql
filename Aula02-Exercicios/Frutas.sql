...
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Danone", 69.99, 20, '2022-01-01', 5);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Rucula", 3.70, 3, '2021-08-07', 2);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Tomate", 6.00, 4, '2021-08-30', 3);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Agua de coco 2l", 19.00, 2, '2021-09-25', 4);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Carambola", 10.00, 3, '2021-10-01', 1);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Batata Doce", 4.00, 2, '2021-09-12', 3);
insert into tb_produto (produto, preco, qtproduto, dtvencimento, categoria_id) values ("Repolho", 8.00, 6, '2021-09-05', 2);
