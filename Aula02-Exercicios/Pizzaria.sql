...
insert into tb_categoria(descricao, ativo) values ("Esfirra Fechada", true);
...
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("Frango com Catupiry", 28.90, 3, '2021-07-16', 5);
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("4 Queijos", 3.20, 15, '2021-07-16', 4);
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("Carne", 2.50, 20, '2021-07-10', 4);
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("Romeu e Julieta", 4.00, 5, '2021-07-21', 3);
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("Portuguesa", 51.99, 1, '2021-07-20', 2);
insert into tb_pizza (sabor, preco, qtproduto, dtpedido, categoria_id) values ("Brigadeiro", 65.00, 1, '2021-07-10', 1);
